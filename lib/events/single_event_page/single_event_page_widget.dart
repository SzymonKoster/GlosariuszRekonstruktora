...
class _SingleEventPageWidgetState extends State<SingleEventPageWidget> {
  ...
  Widget build(BuildContext context) {
    ...
    return StreamBuilder<EventCollectionRecord>(
      stream: EventCollectionRecord.getDocument(widget.eventId!),
      builder: (context, snapshot) {
        ...
        final singleEventPageEventCollectionRecord = snapshot.data!;
                                ...
                                Align(
                                  ...
                                  child: Padding(
                                    padding: const EdgeInsetsDirectional.fromSTEB(
                                        0.0, 25.0, 0.0, 0.0),
                                    child: Text(
                                      singleEventPageEventCollectionRecord
                                          .eventName,
                            ...
                            children: [
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 20.0, 0.0, 0.0),
                                child: Text(
                                  singleEventPageEventCollectionRecord.startYear
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
                              ...
                              Padding(
                                padding: const EdgeInsetsDirectional.fromSTEB(
                                    0.0, 20.0, 0.0, 0.0),
                                child: Text(
                                  singleEventPageEventCollectionRecord.endYear
                                      .toString(),
                                  style: FlutterFlowTheme.of(context)
                                      .bodyMedium
                                      .override(
